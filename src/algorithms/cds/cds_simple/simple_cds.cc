...
void SimpleCDSAlg::set_alg_type() { EV << "SimpleCDSAlg::set_alg_type()\n"; alg_type = CDS_ALG; }
...
void SimpleCDSAlg::init_CDS() {
    CDS_stage_starting_round = MIS_stage_starting_round + MIS_stage_max_num_rounds;
...
SimpleCDSAlg::SimpleCDSAlg(Node *node, int starting_round) {
    ...
    EV << "MIS_stage_starting_round = " << MIS_stage_starting_round << ' ' << SW08_MIS_alg->starting_round << '\n';
    EV << "CDS_stage_starting_round = " << CDS_stage_starting_round << ' ' << CDS_alg->starting_round << '\n';
