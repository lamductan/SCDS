...
void LamMISAlg::set_alg_type() { EV << "GP22MIS::set_alg_type()\n"; alg_type = MIS_ALG; }
...
LamMISAlg::LamMISAlg(Node *node, int starting_round) {
    ...
    Lam_MIS_part1_2_alg = new LamInformingNeighborsAlg(node, part1_2_starting_round);
    ...
    EV << "LamMISAlg::part1_starting_round = " << part1_starting_round << ' ' << Lam_MIS_part1_alg->starting_round << '\n';
    EV << "LamMISAlg::part1_2_starting_round = " << part1_2_starting_round << ' ' << Lam_MIS_part1_2_alg->starting_round << '\n';
    EV << "LamMISAlg::part3_starting_round = " << part3_starting_round << ' ' << Lam_MIS_part3_alg->starting_round << '\n';
