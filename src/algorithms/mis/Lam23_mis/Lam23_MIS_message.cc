...
void LamMISMessage::copyInformation(LamTwoRSNodeStatus two_rs_status, int color, int two_rs_cluster_center_id) {
...
LamMISMessage::LamMISMessage(const LamMISMessage& other) : LubyMISMessage((LubyMISMessage) other) {
    copyInformation(other.two_rs_status, other.color, other.two_rs_cluster_center_id);
}
...
int LamMISMessage::getClusterCenterId() const { return two_rs_cluster_center_id; }
